...
- S3 ESP-32-S3-DevKitC-1 WROOM-1-N16R8
    [Datasheet](esp-dev-kits-en-master-esp32s3.pdf)

### Buck convertissor

- VERTER 5V USB Buck-Boost - 500mA from 3V-5V / 1000ma from 5V-12V
    [Datasheet](VERTER-5V-USB-Buck-Boost.pdf)

### Motor Driver

- Adafruit TB6612 1.2A DC/Stepper Motor Driver Breakout Board
    [Datasheet](adafruit-tb6612-h-bridge-dc-stepper-motor-driver-breakout.pdf)

### IMU

- Adafruit LSM9DS1 Accelerometer + Gyro + Magnetometer 9-DOF Breakout
    [Datasheet](adafruit-lsm9ds1-accelerometer-plus-gyro-plus-magnetometer-9-dof-breakout.pdf)

### Lidar

- SLAMTEC rplidar A2M8
    [Datasheet](LD208_SLAMTEC_rplidar_datasheet_A2M8_v2.6_en.pdf)
